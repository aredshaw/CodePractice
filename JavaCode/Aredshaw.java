...
public class Aredshaw {
  public static void main(String args[]) {
      ...
      final String text = "<center><h1>Aaron K. Redshaw</h1></center>\n"
          + "<center><p><strong>Technical Writer &ndash; Developer Docs / APIs</strong></p></center>\n"
          ...
          + "<p><h2>Technical Writer &ndash; Expert Support (Placed at Google) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;03/2019&ndash; Present</h2></p>\n"
          ...
          + "</ul>\n"
          + "<p><h2>Technical Writer - <a href=\"http://www.clyste.com\"><strong>Clyste </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;08/2018 &ndash; 02/2019</h2><strong><br /></strong>A user owned, governed, and developed blockchain based social media, app store, and ERP.</p>\n"
          + "<ul>\n"
          ...
          + "</ul>\n"
          + "<p><h2>English Teacher - Independence H.S., San Jose, CA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;08/2003 &ndash; 08/2018</h2></p>\n"
          + "<ul>\n"
          ...
          + "</ul>\n"
          + "<p><h2>Technical Support - Verio-WebCom, Santa Cruz, CA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;07/1999 &ndash; 09/2002</h2></p>\n"
          + "<ul>\n"
          ...
          + "</ul>\n"
          + "<p><h1>Education</h1></p>\n"
          + "<p><strong>Teaching Credential with CLAD, San Jose State University, San Jose, CA</strong> <strong>2002 &ndash; 2003</strong></p>\n"
          + "<ul>\n"
          + "<li>Finished credential while concurrently teaching high school full-time</li>\n"
          + "</ul>\n"
          + "<p><strong>B.A. English, Bethany College, Scotts Valley, CA</strong> <strong>1993 &ndash; 1996</strong></p>\n"
          + "<ul>\n"
